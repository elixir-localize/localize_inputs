defmodule Localize.Inputs.Unit do
  @moduledoc """
  Locale-derived display data for unit form inputs.

  Mirrors `Localize.Inputs.Number` but for the unit picker —
  ...
  * `{:error, Exception.t()}` when the locale can't be parsed
  ...
  ### Examples
      ...
      iex> {:ok, info} = Localize.Inputs.Unit.unit_for_locale(:en, category: "length")
      iex> info.measurement_system
      :us

      iex> {:ok, info} = Localize.Inputs.Unit.unit_for_locale(:fr, category: "length")
      iex> info.measurement_system
      :metric

      iex> {:ok, info} = Localize.Inputs.Unit.unit_for_locale(:en, category: "length", unit: "meter")
      iex> info.unit
      "meter"
